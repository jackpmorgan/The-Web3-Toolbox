function(instance, properties, context) {
  ...
  try {
    ...
    instance.publishState('721_signature_mint_token_id', parseInt(trimmed, 16));
    instance.triggerEvent('721_nft_signature_minted');
  
  } catch (error) {
    console.log(error);
    const errorcode = JSON.stringify(error.reason);
    instance.publishState('721_signature_mint_error', errorcode);
    instance.triggerEvent('721_signature_mint_error');
  }
