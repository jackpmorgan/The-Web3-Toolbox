function(instance, properties, context) {
  ...
  try {
    ...
    instance.publishState('nft_drop_claim_conditions_set_tx', txString);
    instance.triggerEvent('nft_drop_claim_conditions_set');
  
  } catch (error) {
    console.log(error);
    const errorcode = JSON.stringify(error.reason);
    instance.publishState('nft_drop_claim_conditions_error', errorcode);
    instance.triggerEvent('nft_drop_claim_conditions_error');
  }
